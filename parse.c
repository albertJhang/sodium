...
// 解析期間所建立的區域變數實例都是累計到這個清單中 All local variable instances created during parsing are
// accumulated to this list.
static VarList *locals;
static VarList *globals;

// 按名稱搜尋區域變數 Find a local variable by name.
...
// stmt-expr = "(" "{" stmt stmt* "}" ")"
//
//Stmatement expression is a GNU C extension.
static Node *stmt_expr(Token *tok) {
  ...
  if (cur->kind != ND_EXPR_STMT)
    error_tok(cur->tok, "stmt expr returning void is not support");
